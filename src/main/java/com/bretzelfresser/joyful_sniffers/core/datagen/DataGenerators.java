...
import com.bretzelfresser.joyful_sniffers.core.datagen.server.ModBlockTagsProvider;
import com.bretzelfresser.joyful_sniffers.core.datagen.server.ModItemTagsProvider;
...
public class DataGenerators {
    ...
    private static void gatherServerData(DataGenerator gen, ExistingFileHelper helper) {
        ...
        gen.addProvider(true, new ModItemTagsProvider(gen, blockTags, helper));
    }
}
